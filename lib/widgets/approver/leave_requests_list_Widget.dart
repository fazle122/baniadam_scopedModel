...
import 'package:baniadam/pages/admin/leaveRequestDetail.dart';
...
//    print(finalTime);
  ...
  Future<List> _leaveApprovalDialog(
      BuildContext context, id, approveType) async {
...
//                          margin: EdgeInsets.only(top: 5.0),
                      ...
                      Container(
//                          margin: EdgeInsets.only(top: 5.0),
                          child: requestData.fromDate != null &&
                                  requestData.fromDate != 'n/a'
                              ? Text(
...
//                          margin: EdgeInsets.only(top: 5.0),
                      ...
                      Container(
//                          margin: EdgeInsets.only(top: 5.0),
                          child: requestData.toDate != null &&
                                  requestData.toDate != 'n/a'
                              ? Text(requestData.toDate)
                              : Text('No data')),
                    ],
                  ),
                ],
...
//                          margin: EdgeInsets.only(top: 5.0),
          ...
          onTap: () {
            Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        LeaveRequestDetailPage(requestData.id, model)));
          },
        ),
//              )
      );
